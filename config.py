...
# hotfix_sqlalchemy21: name the driver explicitly. SQLAlchemy 2.1 made psycopg (v3) the default for a bare
# postgresql:// URL; the image ships psycopg2-binary. Without this the app crash-loops in migrate.py.
